...
import { startOfMonth, endOfMonth, eachDayOfInterval, isSameMonth, isToday, format, addDays, subDays } from 'date-fns';

function generateCalendarArrayWithEvents(targetDate) {
...
export default function Calendar() {
  ...
  const days = generateCalendarArrayWithEvents(currentMonth);
  console.log(days);
    ...
    <div className="h-screen flex flex-col">
        ...
        <header className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none">
            ...
            <div className="ml-6 h-6 w-px bg-gray-300" />
                <button
                type="button"
                className="ml-6 rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
                >
                Add event
                </button> 
            </div> */}
                ...
                <div className="hidden w-full lg:grid lg:grid-cols-7 lg:grid-rows-6 lg:gap-px">
                    {days.map((day) => (
                        ...
                        className={classNames(
                            ...
                            !day.isWorkingDay && 'text-red-600', // Apply red color for non-working days
                            'relative px-3 py-2'
                        )}
                        >
                        <time
